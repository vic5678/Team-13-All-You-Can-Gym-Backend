...
export const getAllSubscriptionPackages = async (req, res) => {
    try {
        ...
        return successResponse(res, 200, SUBSCRIPTION_PACKAGES_RETRIEVED, result.data);
    } catch (error) {
        return errorResponse(res, 500, SUBSCRIPTION_PACKAGES_NOT_FOUND, error.message);
    }
};
...
export const getSubscriptionPackageById = async (req, res) => {
    try {
        ...
        return successResponse(res, 200, SUBSCRIPTION_PACKAGE_RETRIEVED, result);
    } catch (error) {
        return errorResponse(res, 500, SUBSCRIPTION_PACKAGE_NOT_FOUND, error.message);
    }
};
...
export const getUserSubscriptions = async (req, res) => {
    try {
        ...
        return successResponse(res, 200, SUBSCRIPTION_RETRIEVED, result.data);
    } catch (error) {
